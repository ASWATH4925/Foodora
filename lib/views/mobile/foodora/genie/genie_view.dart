            ...
            children: <Widget>[
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text('Genie', style: Theme.of(context).textTheme.headlineLarge),
              ...
              _GenieCardView(
                ...
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Genie: Buy Anything coming soon!')),
                  );
                },
              ),
              _GenieCardView(
                ...
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Genie: Pickup & Drop coming soon!')),
                  );
                },
              )
            ],
